  ...
  _createClass(VerifyCert, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var hashedCert, transaction, functionSignature, input2, lhs, fromAccount, method, params;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                lhs = transaction.from;
                fromAccount = this.state.accounts[0];
                method = 'personal_ecRecover';
                params = [sig, fromAccount];
...
//# sourceMappingURL=index.js.33f5dbcac67000ca705d.hot-update.js.map