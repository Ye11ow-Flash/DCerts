  ...
  _createClass(CertificateForm, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(txHash) {
        var hashedCert, tx, functionSignature;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                ...
                console.log('done');
                console.log(tx);
                functionSignature = _Ethereum_web3__WEBPACK_IMPORTED_MODULE_3__["default"].eth.abi.encodeFunctionSignature('upload(string)'); // var input = web3.eth.abi.decodeParameter('string', tx.input);

                console.log(tx.input); // console.log(tx);
...
//# sourceMappingURL=index.js.bb7c851d8fda9c4a21f0.hot-update.js.map