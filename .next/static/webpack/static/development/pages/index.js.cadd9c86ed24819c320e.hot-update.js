  ...
  _createClass(CertificateForm, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(txHash) {
        var hashedCert, functionSignature;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                console.log('waiting..');
                _context3.next = 4;
                return _Ethereum_web3__WEBPACK_IMPORTED_MODULE_3__["default"].eth.getTransaction('0xb2db9336d68ec4ac3ead002181988142f8e597c8a35fa107ee42795df088f0b3', function (err, txResult) {
                  if (err) console.log(err);
                  var result = _Ethereum_web3__WEBPACK_IMPORTED_MODULE_3__["default"].eth.abi.decodeParameter('string', txResult.input);
                });

              case 4:
                console.log('done');
                functionSignature = _Ethereum_web3__WEBPACK_IMPORTED_MODULE_3__["default"].eth.abi.encodeFunctionSignature('upload(string)'); // console.log(tx);
...
//# sourceMappingURL=index.js.cadd9c86ed24819c320e.hot-update.js.map