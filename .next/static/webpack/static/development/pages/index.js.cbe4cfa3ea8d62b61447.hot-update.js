          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return reader.readAsDataURL(json[0]).on('load', function (e) {
                  tx = JSON.parse(atob(e.target.result.substring(29)));
                  h = tx.txHash;
                  delete tx.txHash;
...
//# sourceMappingURL=index.js.cbe4cfa3ea8d62b61447.hot-update.js.map